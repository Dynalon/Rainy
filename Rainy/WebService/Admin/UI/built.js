...
// Declare app level module which depends on filters, and services
var app = angular.module('loginApp', ['loginApp.filters', 'loginApp.services', 'loginApp.directives']).
  config(['$routeProvider', function($routeProvider) {
    $routeProvider.when('/login', {templateUrl: 'login.html', controller: LoginCtrl});
    $routeProvider.when('/register', {templateUrl: 'register.html', controller: LoginCtrl });
  }])
...
LoginCtrl.$inject = [ '$scope','$route', '$location' ];
